...
The [systemd_app role](https://github.com/cloudyhomelab/ansible-homelab-collection/blob/main/roles/systemd_app/README.md#secrets) finds that file the same way
...
last stored (see the [role README](https://github.com/cloudyhomelab/ansible-homelab-collection/blob/main/roles/systemd_app/README.md#secrets)), so:
